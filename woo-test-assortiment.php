 ...
 * 
 * Changelog:
 * v1.11.1 - Added total shoptegoed badge to Probeerbox items in the cart. Fixed cart AJAX errors for guest users with cache plugins.
 ...
 * v1.9.1 - Fixed mobile overflow issues and adjusted sticky bar alignment.
 */
